...
export default function EDATTable({ entries, onDelete, onView }: EDATTableProps) {
      ...
      <table className="w-full text-xs sm:text-sm lg:text-base text-left min-w-[1200px] text-emerald-900 dark:text-emerald-300">
        <thead className="text-[10px] sm:text-xs lg:text-sm uppercase bg-emerald-50 dark:bg-emerald-900/50 border-b border-emerald-200 dark:border-emerald-800 font-bold tracking-wider text-emerald-800 dark:text-emerald-100 sticky top-0 z-10">
          <tr>
            ...
            <th scope="col" className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 text-center bg-emerald-50 dark:bg-emerald-900/50 w-[140px] sm:w-[160px] lg:w-[200px]">eDTs #</th>
            <th scope="col" className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 text-center bg-emerald-50 dark:bg-emerald-900/50">Date Forwarded</th>
            ...
            <th scope="col" className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 text-center bg-emerald-50 dark:bg-emerald-900/50">Type of Document</th>
            <th scope="col" className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 text-center bg-emerald-50 dark:bg-emerald-900/50">Action Required</th>
            <th scope="col" className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 text-center bg-emerald-50 dark:bg-emerald-900/50">Due In</th>
          ...
          {entries.length === 0 ? (
            ...
            entries.map((entry) => (
              <tr key={entry.id} className="bg-white dark:bg-emerald-900/20 hover:bg-emerald-50 dark:hover:bg-emerald-800/40 transition-colors group">
                ...
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 font-medium text-emerald-800 dark:text-emerald-200 whitespace-nowrap w-[140px] sm:w-[160px] lg:w-[200px]">{entry.edatsNumber}</td>
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 text-center whitespace-nowrap text-emerald-600/70 dark:text-emerald-400/70">{entry.dateForwarded ? format(new Date(entry.dateForwarded), 'MMM dd, yyyy') : '-'}</td>
                ...
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 text-center max-w-[150px] sm:max-w-[180px] lg:max-w-[240px] xl:max-w-[300px] truncate text-emerald-700/80 dark:text-emerald-300/80" title={entry.documentType}>{entry.documentType || '-'}</td>
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 text-center max-w-[150px] sm:max-w-[180px] lg:max-w-[240px] xl:max-w-[300px] truncate text-emerald-700/80 dark:text-emerald-300/80" title={formatActionRequired(entry.actionRequired)}>{formatActionRequired(entry.actionRequired)}</td>
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 text-center whitespace-nowrap text-emerald-600/70 dark:text-emerald-400/70">{formatDueIn(entry.dueIn)}</td>
                ...
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 text-center whitespace-nowrap text-emerald-600/70 dark:text-emerald-400/70 font-mono text-[10px] sm:text-xs lg:text-sm">{formatTimeReceived(entry.timeReceived)}</td>
                ...
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 text-center">
                  <span className={`px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs lg:text-sm font-bold uppercase ${
                    ...
                    entry.status?.toLowerCase() === 'passed due' ? 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300' :
                ...
                <td className="px-3 sm:px-4 lg:px-6 py-3 lg:py-4 text-right sticky right-0 bg-white dark:bg-emerald-950 group-hover:bg-emerald-50 dark:group-hover:bg-emerald-800 transition-colors z-10 shadow-[-4px_0_4px_rgba(0,0,0,0.05)] dark:shadow-[-4px_0_4px_rgba(0,0,0,0.2)]">
                  <div className="flex justify-end gap-1 sm:gap-2 lg:gap-3">
                    <button onClick={() => onView(entry)} className="p-1.5 sm:p-2 lg:p-2.5 text-blue-500 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-lg transition-all" title="View Details">
